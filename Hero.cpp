#include "Hero.h"
Hero::Hero(const std::string& name, const int maxHp, const int dmg, double attackcooldown,int exp_per_level, int health_per_level, int damage_bonus): Character(name, maxHp, dmg, attackcooldown){
