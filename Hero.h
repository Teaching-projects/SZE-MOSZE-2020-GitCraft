...
private:
    ...
    int physical_damage_bonus_per_level;/// < This is the value of the physical damage bonus.
    ...
    int light_radius;///< This is the radius view of the hero.
    int light_radius_per_level;///< This is the radius view of the hero after a level up.
public:
    ...
    int physical/**< [in] The physical damege points of the character*/, int magical/**< [in] The magical damege points of the character*/
    ...
    const int health_per_level /**< [in] This is the health the character gets after level up.*/ ,
    const int damage_bonus/**< [in] Damage bonus of the character*/, 
    double cooldown_multiplier_per_level/**< [in] This is the attackspeed of the hero, in the levels.*/,
    const int defense/**< [in] Defense points of the character.*/,
    const int light_radius/**< [in] View of the hero*/,
    const int light_radius_per_level=1/**< [in] Increase the light radius of the hero after a level up.*/);
    /// This getter is return the evel of the hero.
    int getLevel(/**< [in] There's no parameter here.*/) const;
    /// This getter is return the experience points of the hero.
    int getXp(/**< [in] There's no parameter here.*/) const;
    /// This getter is return the light radius of the hero.
    int getLightRadius(/**< [in] There's no parameter here.*/) const;
    /// This setter is set the experience points of the hero.
