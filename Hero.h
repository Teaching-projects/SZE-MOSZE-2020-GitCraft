...
public:
	...
	Hero(const std::string& name/** [in] The name of the character.*/, const int maxHp/** [in] The healt points of the character*/, int physical, int magical
    /** [in] The damage of the character*/, double attackcooldown/** [in] The attackspeed of the character*/,
    const int exp_per_level,const int health_per_level,const int damage_bonus, double cooldown_multiplier_per_level, const int defense);
